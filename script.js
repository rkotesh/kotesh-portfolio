...
// Activity Feed
const activities = [
    { type: 'project', text: 'Deployed Hospital Chatbot to Streamlit', time: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
    { type: 'skill', text: 'Completed MERN Stack training', time: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000) },
    { type: 'project', text: 'Published QR Code Generator app', time: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) },
    { type: 'learning', text: 'Advanced Python programming studies', time: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000) },
];
